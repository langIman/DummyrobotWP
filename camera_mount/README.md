...
> **2026-09-12：V1 已停用，请勿继续打印本目录 `output/` 的旧文件。**
> 用户实物电机为 **35 × 35 × 35 mm**，与 V1 使用的 20 mm 不一致。
> 此外 V1 转轴开孔方向错误，接口/插头也未完整建模，旧 `verification.json`
> 不能作为可装配的依据。新版见 [V2 说明](v2/README.md)；
> 用户已认可尺寸方案，可下载 [V2 试装打印包](v2/V2_trial_print_2026-09-12.zip)。
...
更正：厂家图实际标有安装孔 `Ø2`；V1 的 `Ø2.4` 是打印通孔设计值，不能当作 PCB
孔径。V1 所引用的电机几何与用户实物不符，且转轴孔并未正确贯通。请使用上方链接
查看 V2 核对草案，不再打印 V1。
